...
export default function Navbar() {
    ...
    return (
        <header
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "navbar-blur shadow-sm" : "bg-transparent"
                }`}
        >
            <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <a
                    href="#"
                    className="flex items-center gap-2.5 animate-slide-left group"
                >
                ...
                <nav className="hidden md:flex items-center gap-8 animate-fade-in delay-200">
                    {["Features", "Research", "Documentation"].map((item) => (
                        <a
                            key={item}
                            href="#"
